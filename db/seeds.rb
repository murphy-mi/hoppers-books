...
Book.create(title: "Battle For The American Mind", price: 7.61, author: "Pete Hegseth", genre: "Hardcover Nonfiction", image: "https://storage.googleapis.com/du-prd/books/images/9780063215047.jpg" )
Book.create(title: "Finding Me", price: 4.95, author: "Viola Davis", genre: "Hardcover Nonfiction", image: "https://storage.googleapis.com/du-prd/books/images/9780063037328.jpg" )
Book.create(title: "Happy-Go-Lucky", price: 7.50, author: "David Sedaris", genre: "Hardcover Nonfiction", image: "https://storage.googleapis.com/du-prd/books/images/9780316392457.jpg" )
...
Book.create(title: "I'd Like To Play Alone, Please", price: 8.09, author: "Tom Segura", genre: "Hardcover Nonfiction", image: "https://storage.googleapis.com/du-prd/books/images/9781538704639.jpg" )
Book.create(title: "The 1619 Project", price: 8.56, author: "Nikole Hannah-Jones", genre: "Hardcover Nonfiction", image: "https://storage.googleapis.com/du-prd/books/images/9780593230572.jpg" )
Book.create(title: "Scars And Stripes", price: 4.73, author: "Tim Kennedy", genre: "Hardcover Nonfiction", image: "https://storage.googleapis.com/du-prd/books/images/9781982190910.jpg" )
Book.create(title: "Untamed", price: 9.45, author: "Glennon Doyle", genre: "Hardcover Nonfiction", image: "https://storage.googleapis.com/du-prd/books/images/9781984801258.jpg" )
